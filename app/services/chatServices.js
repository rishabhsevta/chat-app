...
chatService.find = async (criteria, projection = {}) => {
    return await chatModel.find(criteria, projection).lean();
};
...
* function to update One.
*/
chatService.updateOne = async (criteria, dataToUpdate, projection = {}) => {
    return await chatModel.updateOne(criteria, dataToUpdate, projection).lean();
};
