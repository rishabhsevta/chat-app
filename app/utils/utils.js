...
const { AWS, SMTP, WEB_URL, ADMIN_WEB_URL, PINO, ENVIRONMENT, LIVE_LOGGER_ENABLE } = require('../../config');
...
commonFunctions.emailTypes = (user, type) => {
    ...
    switch (type) {
        case CONSTANTS.EMAIL_TYPES.RESET_PASSWORD_EMAIL:
            EmailStatus['Subject'] = CONSTANTS.EMAIL_SUBJECTS.RESET_PASSWORD_LINK;
