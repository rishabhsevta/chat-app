...
let defaults = {
    ...
    _SERVER_URL: process.env._SERVER_URL || 'http://localhost:3000',
    ...
    _LOADBALANCING_ENABLE: process.env._LOADBALANCING_ENABLE || false,
    ...
    MONGODB: {
        ...
        NAME: process.env.DB_NAME || 'rishabh',
    ...
    SERVER: {
        ...
        _PORT: process.env.SERVER__PORT || '4000',
